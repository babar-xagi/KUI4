...
$JarPath = Join-Path $BuildDir "UI4CoreAndLayoutTest.jar"
...
$AllSources += (Join-Path $RepoRoot "tests\UI4CoreAndLayoutTest.kt")

Write-Host "[KUI4] Compiling UI4CoreAndLayoutTest.kt with kotlinc..." -ForegroundColor Cyan
...
Write-Host "[KUI4] Executing Milestone D Test Suite with java..." -ForegroundColor Cyan
& java -cp $JarPath tests.UI4CoreAndLayoutTestKt
...
Write-Host "[KUI4] Milestone D Verification: ALL PASS" -ForegroundColor Green
